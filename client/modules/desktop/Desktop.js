...
Ext.define('Ext.ux.desktop.Desktop', {
    ...
    initComponent: function () {
        ...
        me.shortcutsView.on('itemcontextmenu', me.onItemContextClick, me);
        //me.shortcutsView.on('contextMenu', me.onContextClick, me);
    ...
    afterRender: function () {
        var me = this;
        me.callParent();
        me.el.on('contextmenu', me.onContextClick, me);
    },
    //------------------------------------------------------
    ...
    createWindowMenu: function () {
        ...
        return {
            defaultAlign: 'br-tr',
            items: [
                {text: 'Restaurer', handler: me.onWindowMenuRestore, scope: me},
                {text: 'Minimiser', handler: me.onWindowMenuMinimize, scope: me},
                {text: 'Maximiser', handler: me.onWindowMenuMaximize, scope: me},
                '-',
                {text: 'Fermer', handler: me.onWindowMenuClose, scope: me}
            ],
            listeners: {
