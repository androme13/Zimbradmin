...
Ext.define('MyDesktop.modules.router.Router', {
    ...
    createWindow: function (refer) {
        ...
        if (!win) {
            ...
            var relayDomainsgrid = Ext.create('MyDesktop.modules.common.views.paginggrid.PagingGrid', {
            ...
            var myNetworksgrid = Ext.create('MyDesktop.modules.common.views.paginggrid.PagingGrid', {
